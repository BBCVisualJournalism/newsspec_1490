(function() {
   ...
   /**
    ...
    require(['jquery-1.4','gelui-1/overlay', 'istats-1','/news/special/uk/11/tax_spend_calculator/js/jquery.validate.min.js'], function($, Overlay, istats){
        //jQuery onDomReady
        $(function($) {
            ...
            $nextButton.bind('click', function(ev) {
                ...
                if ($nextButton.hasClass('reset')) {
                    ...
                    istatslog.log(
                        "click", 
                        "news7billion-next-button", 
                        {
                            "active_story": "slide_" + step
                        } 
                    );
                }
            }); //bind on next
            ...
            $mainNav.bind('click', function (ev) {
                ...
                var parent = $(this).parent();
                 if (parent.hasClass('complete')) {
                    ...
                    istatslog.log(
                        "click", 
                        "news7billion-top-navigation-change", 
                        {
                            "active_story": "slide_" + step
                        } 
                    );
    ...
    function createMyPositionUI($){
        ...
        istatslog.log(
            "click", 
            "news7billion-mynumber", 
            {
                "my_position_page": "my-position"
            } 
        );
   ...
   /*
    ...
    function createSummaryUI($, userdata) {
        var countries = ["Afghanistan", "Albania", "Algeria", "Angola", "Argentina", "Armenia", "Aruba", "Australia", "Austria", "Azerbaijan", "Bahamas", "Bahrain", "Bangladesh", "Barbados", "Belarus", "Belgium", "Belize", "Benin", "Bhutan", "Bolivia", "Bosnia-Hercegovina", "Bosnia-Hercegovina", "Botswana", "Brazil", "Brunei", "Brunei", "Bulgaria", "Burkina Faso", "Burma", "Burma", "Burundi", "Cambodia", "Cameroon", "Canada", "Cape Verde", "Central African Republic", "Chad", "Channel Islands", "Chile", "China", "Colombia", "Comoros", "Congo", "Costa Rica", "Croatia", "Cuba", "Cyprus", "Czech Republic", "Democratic Republic of the Congo", "Democratic Republic of the Congo", "Denmark", "Djibouti", "Dominican Republic", "East Timor", "Timor-Leste", "Ecuador", "Egypt", "El Salvador", "Equatorial Guinea", "Eritrea", "Estonia", "Ethiopia", "Fiji", "Finland", "France", "French Guiana", "French Polynesia", "Gabon", "Gambia", "Georgia", "Germany", "Ghana", "Greece", "Grenada", "Guadeloupe", "Guam", "Guatemala", "Guinea", "Guinea-Bissau", "Guyana", "Haiti", "Honduras", "Hong Kong", "Hungary", "Iceland", "India", "Indonesia", "Iran", "Iraq", "Ireland", "Israel", "Italy", "Ivory Coast", "Ivory Coast", "Jamaica", "Japan", "Jordan", "Kazakhstan", "Kenya", "Kuwait", "Kyrgyzstan", "Laos", "Laos", "Latvia", "Lebanon", "Lesotho", "Liberia", "Libya", "Lithuania", "Luxembourg", "Macao", "Macedonia", "Madagascar", "Malawi", "Malaysia", "Maldives", "Mali", "Malta", "Martinique", "Mauritania", "Mauritius", "Mayotte", "Melanesia", "Mexico", "Micronesia", "Micronesia", "Moldova", "Mongolia", "Montenegro", "Morocco", "Mozambique", "Namibia", "Nepal", "Netherlands", "Netherlands Antilles", "New Caledonia", "New Zealand", "Nicaragua", "Niger", "Nigeria", "North Korea", "North Korea", "Norway", "Oman", "Pakistan", "Palestinian Territories", "Panama", "Papua New Guinea", "Paraguay", "Peru", "Philippines", "Poland", "Portugal", "Puerto Rico", "Qatar", "Reunion", "Romania", "Russia", "Rwanda", "Saint Lucia", "Saint Vincent and the Grenadines", "Samoa", "Sao Tome and Principe", "Saudi Arabia", "Senegal", "Serbia", "Sierra Leone", "Singapore", "Slovakia", "Slovenia", "Solomon Islands", "Somalia", "South Africa", "South Korea", "South Korea", "Spain", "Sri Lanka", "Sudan", "Suriname", "Swaziland", "Sweden", "Switzerland", "Syria", "Tajikistan", "Tanzania", "Thailand", "Togo", "Tonga", "Trinidad and Tobago", "Tunisia", "Turkey", "Turkmenistan", "Uganda", "United Kingdom", "United Kingdom", "United Kingdom", "United Kingdom", "United Kingdom", "United Kingdom", "United Kingdom", "United Kingdom", "Ukraine", "UAE", "UAE", "Uruguay", "USA", "USA", "USA", "United States Virgin Islands", "United States Virgin Islands", "Uzbekistan", "Vanuatu", "Venezuela", "Vietnam", "Western Sahara", "Yemen", "Zambia", "Zimbabwe"];
        ...
        if (userdata) {
            ...
            var userCountryName = countries[parseInt(usercountry, radix)];
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("div#summary_id").html(template.friendSummaryId.interpolate({s_age: userage, s_gender: usergender, s_country_pref:usercountryprefix, s_country: userCountryName}));
                    $("div#summary_position").html(template.friendSummaryPosition.interpolate({s_position: userposition}));
                    $("div#summary_nation p").html(userCountryName);
            ...
            $('div#summary_nation').css('background-image', 'url("/news/special/world/11/7_billion/app/img/small_maps/' + cleanCountryName(userCountryName) + '.gif")');
            ...
            $.each(countries, function(index, value) {
                if (value === userProfile.nationality) {
                    countryCode = index;
                    return;
                }
            });
            ...
            var shareHash = encodeURI(sgender +'~'+userProfile.lifeExpectancy +'~'+ userProfile.myposition+userProfile.myposionSuffix+'~'+ userProfile.nationalPopulation+'~'+ countryCode +'~'+userProfile.nationalityPrefix +'~'+userProfile.userAge +'~'+ userProfile.worldTotal+'~'+profileConclusion);
            ...
            var urlTitle = "&title=" + encodeURIComponent("7 billion people and you: My number is " + addCommas(userProfile.myposition) + " #whatsyournumber ? ");
            ...
            /*$.ajax({
                ...
                success: function(data) {
                    ...
                    if(shorturl == 'undefined') {
                        shorturl = 'http://bbc.in/rXYCff';
                        //istats logging
                        istatslog.log(
                            "error", 
                            "news7billion", 
                            {
                                "url_limit_exceeded": "summary_page"
                            } 
                        );
                    }
			*/	
					var shorturl = 'http://bbc.in/rXYCff';
                    var myfullShareUrl = shareToolsUrl + shorturl + urlTitle + appId;
